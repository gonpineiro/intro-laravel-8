    ...
    <div class="p-8 bg-gray-200 col-span-1">
        <ul flex- flex-col>
            ...
            <li class="flex items-center text-gray-600 mt-2">
                {{$post->name}}
                @if ($post->free)
                <span class="text-xs text-gray-500 font-semibol bg-gray-300 px-2 rounded-fill ml-auto">
                    Gratis
                </span>
                @endif
            </li>
...
<div class="text-center mt-4">
    ...
    <h2 class="text-xl text-gray-600">Fórmate online como profesional en tenología</h2>
</div>
